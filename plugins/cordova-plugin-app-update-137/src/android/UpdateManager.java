...
public class UpdateManager {
    ...
    private UpdateNowThread updateNowThread;
    ...
    public UpdateManager options(JSONArray args, CallbackContext callbackContext)
        ...
        mHashMap.put("url", this.updateXmlUrl);
        mHashMap.put("name", "android.apk");
        return this;
    }
    ...
    public void updateNow() {
        ...
        updateNowThread = new UpdateNowThread(mContext, mHandler, queue, packageName, updateXmlUrl);
        this.cordova.getThreadPool().execute(updateNowThread);
        //new Thread(checkUpdateThread).start();
    }
    ...
    private void downloadApk(AlertDialog mDownloadDialog, ProgressBar mProgress) {
        ...
        // 启动新线程下载软件
        downloadApkThread = new DownloadApkThread(mContext, mHandler, mProgress, mDownloadDialog, mHashMap);
