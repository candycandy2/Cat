CREATE proc [dbo].[usp_Relieve_Booking]
(
	@Site		Nvarchar(3),
	@EmpNo		Nvarchar(50),
...
-- 查看目前的OWVID
Select @OWVID = OWVID From Relieve_OWVID_Veiw
...
-- 宣告迴圈變數 切割BTime的參數
Select part From Relieve_SplitString(@BTime,',')
...
-- Insert Script
Insert into Relieve_Booking_Date ( OWVID, EmpNo, ClassIndex, STime, ETime, Status, CreDate )
...
-- 20170915 Hakkinen 新增備註預約來源為 Relieve APP Rsesrved
--Insert into Relieve_Booking_List ( OWVID, EmpNo, ClassIndex, ReservedTime, STime, ETime, Status, CreDate )
Insert into Relieve_Booking_List ( OWVID, EmpNo, ClassIndex, ReservedTime, STime, ETime, Status, CreDate, Source )
Values ( @OWVID, @EmpNo, @ConvertSite, @FinalTime, @FinalSTime, @FinalETime, 1, GetDate(), 'Relieve APP Rsesrved' )
