...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_ens' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_ENS', 'localhost'),
            'port' => env('DB_PORT_ENS', '3306'),
        ...
        'mysql_qmessage' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_QMESSAGE', 'localhost'),
            'port' => env('DB_PORT_QMESSAGE', '3306'),
            'database' => env('DB_DATABASE_QMESSAGE', ''),
            'username' => env('DB_USERNAME_QMESSAGE', ''),
            'password' => env('DB_PASSWORD_QMESSAGE', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_general_ci',
            'prefix' => '',
            'strict' => false,
        ...
        'mongodb_qmessage' => [
            'driver'   => 'mongodb',
            'host'     => env('MONGO_HOST_QMESSAGE'),
            'port'     => env('MONGO_PORT_QMESSAGE'),
            'database' => env('MONGO_DB_QMESSAGE'),
            'username' => env('MONGO_USERNAME_QMESSAGE'),
            'password' => env('MONGO_PWD_QMESSAGE'),
            'options' => [
                'database' => env('MONGO_AUTH_DB_QMESSAGE'), // sets the authentication database required by mongo 3
                'username' => env('MONGO_AUTH_USERNAME_QMESSAGE'),
                'password' => env('MONGO_AUTH_PWD_QMESSAGE'),
            ]
        ],
    ],
