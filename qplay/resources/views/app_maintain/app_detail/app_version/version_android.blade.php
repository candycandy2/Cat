...
<div>
    ...
    <table id="gridAndroidVersionList" class="bootstrapTable version-grid android-grid" data-toggle="table" data-sort-name="row_id" data-toolbar="#toolbarAndroid"
        ...
        <tr>
            ...
            <th data-field="ready_date" data-sortable="false" data-formatter="readyDateFormatter" data-width="150px">{{trans('messages.READY_DATE')}}</th>
...
<div>
    ...
    <table id="gridAndroidOnlineVersionList" class="bootstrapTable version-grid android-grid" data-toggle="table" data-sort-name="row_id" data-toolbar="#toolbarAndroidOnlineVersionList"
...
<div>
    ...
    <table id="gridAndroidHistoryVersionList" class="bootstrapTable version-grid android-grid" data-toggle="table"
            data-sort-name="ready_date" data-sort-order="desc" data-toolbar="#toolbarAndroidHistoryVersionList" data-url="AppVersion/getAppHistoryVersion?app_row_id={{app('request')->input('app_row_id')}}&device_type=android"
        ...
        <tr>
            ...
            <th data-field="ready_date" data-sortable="false" data-formatter="readyDateFormatter" data-width="150px">{{trans('messages.READY_DATE')}}</th>
            <th data-field="size" data-formatter="fileSizeFormatter" data-sortable="false" data-searchable="false">{{trans('messages.FILE_SIZE')}}</th>
            <th data-field="status" data-formatter="historySwitchFormatter"  data-sortable="false" data-width="150px" >{{trans('messages.VERSION_STATUS')}}</th>
        </tr>
        </thead>
    </table>
</div>