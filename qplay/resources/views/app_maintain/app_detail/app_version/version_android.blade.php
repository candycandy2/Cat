<div id="toolbarAndroid">
    <div class="form-group">
        <button type="button" class="btn btn-danger" style="display: none" onclick="delAppVersion('android')" id="btnDelAndroidVersion">
...
<table id="gridAndroidVersionList" class="bootstrapTable" data-toggle="table" data-sort-name="row_id" data-toolbar="#toolbarAndroid"
       data-url="AppMaintain/getAppVersionList?app_row_id={{app('request')->input('app_row_id')}}&device_type=android" data-height="398" data-pagination="true"
