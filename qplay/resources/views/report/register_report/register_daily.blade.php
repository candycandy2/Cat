...
<div class="row js-report-block"  style="margin:5% 0 5% 0">
    ...
    <div class="col-lg-10 col-xs-12" id="">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12" id="">
            <div id="container_stock_register_daily_1" style="height: 400px; min-width: 310px"></div>
        </div>
    </div>
</div>
...
<div class="row js-report-block"  style="margin:5% 0 5% 0">
     <div class="col-lg-1" id=""></div>
    <div class="col-lg-10 col-xs-12" id="">
        <div id="register_daily_donutchart">
            <div><label class="text-muted"></label></div>
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div id="container_donut_chart_register_daily_1"  style="height: 500px;"></div>
            </div>
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div id="container_donut_chart_register_daily_2"  style="height: 500px;"></div>    
            </div>
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div id="container_donut_chart_register_daily_3"  style="height: 500px;"></div>    
            </div>
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div id="container_donut_chart_register_daily_4"  style="height: 500px;"></div>    
            </div>
        </div>
    </div>
</div>
