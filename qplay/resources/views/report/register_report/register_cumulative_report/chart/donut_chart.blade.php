...
var updateCumulativeRegisterDonutChart = function(r, queryDate){
    ...
    setCumulativeRegisterDonutChartData(r,'1', queryDate, $('#container_donut_chart_{{$REPORT_TYPE}}_1').highcharts());
    setCumulativeRegisterDonutChartData(r,'2', queryDate, $('#container_donut_chart_{{$REPORT_TYPE}}_2').highcharts());
    setCumulativeRegisterDonutChartData(r,'3', queryDate, $('#container_donut_chart_{{$REPORT_TYPE}}_3').highcharts());
    setCumulativeRegisterDonutChartData(r,'4', queryDate, $('#container_donut_chart_{{$REPORT_TYPE}}_4').highcharts());
}
