 ...
 * Generated for Laravel 5.0.33 on 2016-03-30.
 *
...
if ( ! function_exists('with'))
{
    ...
    class CloudStorage extends \App\lib\CloudStorage\Facade\CloudStorage{
         ...
         * @static 
         */
        public static function getObjectUrl($key, $expires = null, $args = array()){
            return \App\lib\CloudStorage\Driver\AwsS3Driver::getObjectUrl($key, $expires, $args);
        }
         ...
         * @static 
         */
        public static function putObject($bucket, $key, $sourceFile){
            return \App\lib\CloudStorage\Driver\AwsS3Driver::putObject($bucket, $key, $sourceFile);
        }
