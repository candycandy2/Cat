$("#viewQPayShopChangePassword").pagecontainer({
    create: function (event, ui) {
        ...
        function changeQAccountPwd(oldPwd, newPwd) {
            ...
            this.successCallback = function (data) {
                ...
                if (data['result_code'] == '1') {
                    //popup:交易密码更改成功
                    $('#viewQPayShopChangePassword .page-back').trigger('click');
        ...
        /********************************** page event ***********************************/
        $("#viewQPayShopChangePassword").on("pagebeforeshow", function (event, ui) {

        });

        $("#viewQPayShopChangePassword").one("pageshow", function (event, ui) {
        ...
        $("#viewQPayShopChangePassword").on("pageshow", function (event, ui) {

        });

        $("#viewQPayShopChangePassword").on("pagehide", function (event, ui) {
            //initial
            initialPage();
        });
        ...
        $('.shop-change-pwd').on('touchend', function () {
            $('#viewQPayShopChangePassword .ui-header').removeClass('ui-fixed-hidden');
        });
