$("#viewQPayShopMain").pagecontainer({
    create: function (event, ui) {
        ...
        /********************************** page event ***********************************/
        $("#viewQPayShopMain").on("pagebeforeshow", function (event, ui) {
        ...
        $('.shop-pay').on('click', function () {
            checkWidgetPage('viewQPayShopSearchUser', pageVisitedList);
        });

        //店家记录
        $('.shop-record').on('click', function () {
            checkWidgetPage('viewQPayShopQueryRecord', pageVisitedList);
        });
