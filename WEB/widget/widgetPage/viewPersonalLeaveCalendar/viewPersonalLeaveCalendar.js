    ...
    create: function(event, ui) {
        ...
        window.QueryCalendarData = function() {
            ...
            var __construct = function() {
                CustomAPIEx("POST", true, "QueryCalendarData", self.successCallback, self.failCallback, queryCalendarData, "", 60);
            }();
        };
        ...
        $(document).on('click', '#viewPersonalLeaveCalendar .leaveMenu', function() {
            $("#mypanel").panel("open");
            $(".page-mask").show();
        });      
