$("#viewQPayShopToAccount").pagecontainer({
    create: function (event, ui) {
        ...
        /********************************** page event ***********************************/
        $("#viewQPayShopToAccount").on("pagebeforeshow", function (event, ui) {
            getCurrentLoginEmp();
        });

        $("#viewQPayShopToAccount").one("pageshow", function (event, ui) {
            var dueDay = getDueDay();
            $('.acount-due-day').text(dueDay);
            getCurrentLoginEmp();
        });

        $("#viewQPayShopToAccount").on("pageshow", function (event, ui) {
            //解除原本的事件监听
        ...
        $("#viewQPayShopToAccount").on("pagehide", function (event, ui) {
        ...
        $('.user-acount-pay').on('click', function () {
            checkWidgetPage('viewQPayShopInputPrice', pageVisitedList);
        });
        ...
        //确定继续结帐
        $('#viewQPayShopToAccount .btn-cancel').on('click', function () {
        ...
        //返回
        $('#viewQPayShopToAccount .page-back-trigger').on('click', function () {
            $('#logoutUserAcount').popup('open');
        });
