$("#viewQPayShopRecordList").pagecontainer({
    create: function (event, ui) {
        ...
        function setPageHeight() {
            var headHeight = $('#viewQPayShopRecordList .page-header').height();
        ...
        /********************************** page event ***********************************/
        $("#viewQPayShopRecordList").on("pagebeforeshow", function (event, ui) {

        });

        $("#viewQPayShopRecordList").one("pageshow", function (event, ui) {

        });

        $("#viewQPayShopRecordList").on("pageshow", function (event, ui) {
            //API：获取交易记录
