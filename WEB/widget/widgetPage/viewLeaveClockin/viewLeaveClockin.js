...
$("#viewLeaveClockin").pagecontainer({
    create: function(event, ui) {
        ...
        $("#viewLeaveClockin").on("pageshow", function(event, ui) {
        ...
        /********************************** dom event *************************************/
        $("#viewLeaveClockin").keypress(function(event) {
        ...
        $("#previewClockinBtn").on("click", function() {
            ...
            if ($('#previewClockinBtn').hasClass('leavePreview-active-btn')) {
                ...
                $('#viewLeaveClockin .leaveMenu').hide();
                $('.apply-preview').show();
                $('#backClockin').show();
                $("#confirmBtn").show();
            }
        ...
        $("#backClockin").on("click", function() {
            ...
            $('#viewLeaveClockin .leaveMenu').show();
            //return false;
        });
        ...
        $(document).on('click', '#viewLeaveClockin .leaveMenu', function() {
            $("#mypanel").panel("open");
            $(".page-mask").show();
        });          
