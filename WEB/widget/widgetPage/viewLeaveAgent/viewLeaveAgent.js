...
$("#viewLeaveAgent").pagecontainer({
    create: function(event, ui) {
        ...
        window.GetAgentDeptAuthority = function() {
            ...
            this.successCallback = function(data) {
                ...
                if (data['ResultCode'] === "1") {
                    ...
                    //生成所有类别dropdownlist
                    tplJS.DropdownList("viewLeaveAgent", "agentDept", "prepend", "typeB", deptData);
        ...
        /********************************** page event *************************************/
        $("#viewLeaveAgent").one("pageshow", function(event, ui) {
            $("#agentDept").empty();
            $("#dept-popup-option-popup").empty();
            ...
            tplJS.DropdownList("viewLeaveAgent", "agentName", "prepend", "typeB", deptAgentData);
        });

        $("#viewLeaveAgent").on("pageshow", function(event, ui) {
        ...
        $(document).on('click', '#viewLeaveAgent .leaveMenu', function() {
            $("#mypanel").panel("open");
            $(".page-mask").show();
        });          
