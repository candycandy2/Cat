$("#viewWebNews2-3-1").pagecontainer({
    create: function (event, ui) {
        ...
        function QueryMessageDetail(messageRowId_) {
            ...
            this.successCallback = function (data) {
                ...
                if (resultcode === 1) {
                    ...
                    messageExist = true;
                    updateDetailReadDelete(content.message_type, "read", messageRowId);
                    ...
                    messageExist = false;
                    updateDetailReadDelete("all", "delete", messageRowId);
                }
        ...
        function updateDetailReadDelete(type, status, messageRowId_) {
            var self = this;
        ...
        $("#viewWebNews2-3-1").one("pageshow", function (event, ui) {
            ...
            $('#messageLoadErrorPopup .ui-content > .header').css({
                'height': '25vw',
                'line-height': '25vw'
            });
        });
