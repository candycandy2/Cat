...
function getLeaveByCategory() {
    ...
    tplJS.DropdownList("viewLeaveMain", "leaveGenre", "prepend", "typeB", leaveData);
...
$("#viewLeaveMain").pagecontainer({
    create: function(event, ui) {
        ...
        function getQuickLeaveList() {
            ...
            //生成快速请假dropdownlist
            tplJS.DropdownList("viewLeaveMain", "leaveType", "prepend", "typeB", leaveTypeData);
        ...
        function getAllCategroyList() {
            ...
            //生成所有类别dropdownlist
            tplJS.DropdownList("viewLeaveMain", "leaveCategroy", "prepend", "typeB", categroyData);
        ...
        /********************************** page event *************************************/
        $("#viewLeaveMain").one("pageshow", function(event, ui) {
            $("#tab-1").hide();
            $("#tab-2").show();
            $(".beingAgent").hide();
            if (lastPageID === "viewLeaveMain") {
                //viewPersonalLeave
                tplJS.DropdownList("viewLeaveMain", "agent", "prepend", "typeB", agentData);
                //viewLeaveSubmit
                tplJS.DropdownList("viewLeaveMain", "leaveAgent", "prepend", "typeB", leaveAgentData);
            }
            ...
            if (!viewPersonalLeaveBeforeshow) {
                ...
                if (localStorage.getItem("agent") !== null) {
                    ...
                    if (employeeName == "") {
                        ...
                        //viewPersonalLeave
                        $("#agent-popup option").text(agentName);
                        tplJS.reSizeDropdownList("agent-popup", "typeB");
                        //viewLeaveSubmit
                        $("#leave-agent-popup option").text(agentName);
                        tplJS.reSizeDropdownList("leave-agent-popup", "typeB");
                    }
        ...
        $(document).on('click', '#viewLeaveMain .leaveMenu', function() {
            $("#mypanel").panel("open");
            $(".page-mask").show();
        });          
