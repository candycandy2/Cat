...
(function($) {
    $.widget("jtsage.datebox", {
        ...
        _build: {
            ...
            flipbox: function() {
                //remove ui-overlay-shadow from flipBase
                var i, y, hRow, tmp, hRowIn, stdPos, controlButtons, w = this, o = this.options, g = this.drag, cDurS = {}, normDurPositions = [ "d", "h", "i", "s" ], dur = o.mode === "durationflipbox" ? true : false, uid = "ui-datebox-", uidfc = uid + "flipcontent", flipBase = $("<div><ul></ul></div>"), ctrl = $("<div>", {
                ...
                if (w.wheelExists) {
                    // change .ui-overlay-shadow to .ui-datebox-container
                    w.d.intHTML.on("mousewheel", ".ui-datebox-container", function(e, d) {
                        e.preventDefault();
        ...
        _create: function() {
            ...
            var w = this, runTmp, ranTmp, o = $.extend(this.options, this._getLongOptions(this.element), this.element.data("options")), thisTheme = o.theme === false ? $.mobile.getInheritedTheme(this.element) : o.theme, trans = o.useAnimation ? o.transition : "none", d = {
                ...
                mainWrap: $("<div>", {
                    //remove ui-overlay-shadow after ui-datebox-container
                    class: "ui-datebox-container " + "ui-corner-all ui-datebox-hidden " + trans + " ui-body-" + thisTheme
                }).css("zIndex", o.zindex),
                intHTML: false
