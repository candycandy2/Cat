var StatusPlugin = {
    ...
    QPlayAPI: function(requestType, requestAction, successCallback, failCallback, queryData, queryStr) {
        ...
        var signatureTime = StatusPlugin.getSignature("getTime");
        var signatureInBase64 = StatusPlugin.getSignature("getInBase64", signatureTime, StatusPlugin.appSecretKey);

        $.ajax({
            type: requestType,
            headers: {
                'Content-Type': 'application/json; charset=utf-8',
                'App-Key': StatusPlugin.appKey + StatusPlugin.env,
