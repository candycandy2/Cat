...
gulp.task('install', ['copyRes'], shell.task([
  ...
  'cordova plugin add cordova-plugin-customurlscheme --variable URL_SCHEME=appmassage' + process.env.appNameDecorate,
...
gulp.task('jenkinsinstall', ['copyRes'], shell.task([
  ...
  //set scheme name appXXXX, XXXX should in lowercase.
  'cordova plugin add ../../plugins/cordova-plugin-customurlscheme --nofetch --variable URL_SCHEME=appmassage' + process.env.appNameDecorate,
