...
gulp.task('jenkinsinstall', ['copyRes'], shell.task([
  ...
  'cordova plugin add ../../plugins/cordova-plugin-jcore',
  'cordova plugin add ../../plugins/jpush-phonegap-plugin --nofetch --variable APP_KEY=' + process.env.QPushAPPKey + " --nofetch",
