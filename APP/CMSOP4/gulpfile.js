...
var schemeSetting = "<string>appqplay" + process.env.appNameDecorate + "</string><string>appcmtwo" + process.env.appNameDecorate + "</string>";

var configContent =   '<?xml version="1.0" encoding="utf-8"?>' +
                    //set app id = com.qplay.appXXXX, XXXX should in lowercase.
                    '<widget id="com.qplay.appcmtwo' + process.env.appNameDecorate + '" android-versionCode="' + process.env.vcode + '" ios-CFBundleVersion="' + process.env.vcode + '" ' +
...
gulp.task('install', ['copyRes'], shell.task([
  ...
  //set scheme name appXXXX, XXXX should in lowercase.
  'cordova plugin add cordova-plugin-customurlscheme --variable URL_SCHEME=appcmtwo' + process.env.appNameDecorate,
...
gulp.task('jenkinsinstall', ['copyRes'], shell.task([
  ...
  //set scheme name appXXXX, XXXX should in lowercase.
  'cordova plugin add ../../plugins/cordova-plugin-customurlscheme --nofetch --variable URL_SCHEME=appcmtwo' + process.env.appNameDecorate,
