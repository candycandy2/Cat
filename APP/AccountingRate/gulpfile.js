...
var schemeSetting = "<string>appqplay" + appNameDecorate + "</string><string>appaccountingrate" + appNameDecorate + "</string>";
...
/*
  ...
  */
  ...
  //set scheme name appXXXX, XXXX should in lowercase.
  'cordova plugin add cordova-plugin-customurlscheme --variable URL_SCHEME=appaccountingrate' + appNameDecorate,
...
gulp.task('jenkinsinstall', shell.task([
  ...
  //set scheme name appXXXX, XXXX should in lowercase.
  'cordova plugin add cordova-plugin-customurlscheme@4.2.0 --variable URL_SCHEME=appaccountingrate' + appNameDecorate,
  'cordova plugin add ../../plugins/cordova-plugin-qsecurity --variable SCHEME_SETTING="' + schemeSetting + '"',
