...
env.set({APP_NAME: "AngularYellowPage"});

var requireDir = require('require-dir');
var gulpTask = requireDir('../component/gulpTask/');

/*-----------------------------------------edit config.xml------------------------------------------*/
var schemeSetting = "<string>appqplay" + process.env.appNameDecorate + "</string><string>appangularyellowpage" + process.env.appNameDecorate + "</string>";

var configContent =   '<?xml version="1.0" encoding="utf-8"?>' +
                    '<widget id="com.qplay.appangularyellowpage' + process.env.appNameDecorate + '" android-versionCode="' + process.env.vcode + '" ios-CFBundleVersion="' + process.env.vcode + '" ' +
...
gulp.task('install', ['copyRes'], shell.task([
  ...
  'cordova plugin add cordova-plugin-customurlscheme --variable URL_SCHEME=appangularyellowpage' + process.env.appNameDecorate,
...
gulp.task('jenkinsinstall', ['copyRes'], shell.task([
  ...
  //set scheme name appXXXX, XXXX should in lowercase.
  'cordova plugin add ../../plugins/cordova-plugin-customurlscheme --nofetch --variable URL_SCHEME=appangularyellowpage' + process.env.appNameDecorate,
