...
var schemeSetting = "<string>appqplay" + appNameDecorate + "</string><string>appleave" + appNameDecorate + "</string>";

var configContent =   '<?xml version="1.0" encoding="utf-8"?>' +
                    //set app id = com.qplay.appXXXX, XXXX should in lowercase.
                    '<widget id="com.qplay.appleave' + appNameDecorate + '" android-versionCode="' + vcode + '" ios-CFBundleVersion="' + vcode + '" ' +
