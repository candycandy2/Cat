...
gulp.task('jenkinsinstall', ['copyRes'], shell.task([
  ...
  'cordova plugin add ../../plugins/cordova-plugin-customurlscheme --nofetch --variable URL_SCHEME=appqisdaeis' + process.env.appNameDecorate,
  ...
  'cordova plugin add ../../plugins/cordova-plugin-screen-orientation --nofetch',
