...
sshpass -p "readrsync" rsync -rvh --delete qplay/public/css/ rsyncuser@10.82.246.95:/var/www/html/rsynctest/qplay/public/css/
sshpass -p "readrsync" rsync -rvh --delete qplay/public/js/ rsyncuser@10.82.246.95:/var/www/html/rsynctest/qplay/public/js/
